...
\begin{itemize}
\item {\bf Quizzes}: Most weeks, we will have a quiz (usually on Tuesday). 
\item {\bf Exams}: Periodically we will have longer assessments (usually on Tuesday).
...
Student Hours are Monday 12-3:15 and Wednesday 12-2:45. These will be held in ASC 1303A. 
\end{frame}
